...
create or replace view app_instance_schema.SHARETHIS_DATA as select * from shared_content_schema.SHARETHIS_DATA;
...
grant SELECT on view app_instance_schema.SHARETHIS_DATA to application role app_instance_role;
